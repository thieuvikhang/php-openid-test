 ...
 * @Createdate Sat, 11 Jun 2016 04:27:46 GMT
 */
...
$global_config['allowuserloginmulti']=0;
$global_config['allowuserpublic']=1;
$global_config['allowuserreg']=1;
$global_config['authors_detail_main']=0;
$global_config['auto_login_after_reg']=1;
...
$global_config['cookie_prefix']='nv4c_w1hkr';
...
$global_config['error_send_email']='thieuvikhang@gmail.com';
$global_config['error_set_logs']=1;
$global_config['facebook_client_id']='190240264706946';
$global_config['facebook_client_secret']='b88dbf31a7b21de513a8e207b5b91b57';
...
$global_config['ftp_user_pass']='Jz_uSMiatEPbzGGBKihJHyc_7kjImrRD28xhgSooSR8,';
...
$global_config['openid_servers']=array('facebook');
...
$global_config['session_prefix']='nv4s_k8If2Y';
...
$rewrite_keys=array(0=>'#"(/hutech/)index.php\\?language=([a-z-]+)\\&[amp;]*nv=seek\\&[amp;]*q\\=([^"]+)"#', 1=>'#"(/hutech/)index.php\\?language=([a-z-]+)\\&[amp;]*nv=([a-zA-Z0-9-]+)\\&[amp;]*op=search\\&[amp;]*q\\=([^"]+)"#', 2=>'#"(/hutech/)index.php\\?language=([a-z-]+)\\&[amp;]*nv=([a-zA-Z0-9-]+)\\&[amp;]*op=tag/([^"]+)"#', 3=>'#"(/hutech/)index.php\\?language=([a-z-]+)\\&[amp;]*nv=([a-zA-Z0-9-]+)\\&[amp;]*op=([a-zA-Z0-9-/]+)\\.html"#', 4=>'#"(/hutech/)index.php\\?language=([a-z-]+)\\&[amp;]*nv=([a-zA-Z0-9-]+)\\&[amp;]*op=([a-zA-Z0-9-/]+)"#', 5=>'#"(/hutech/)index.php\\?language=([a-z-]+)\\&[amp;]*nv=([a-zA-Z0-9-/]+)"#', 6=>'#"(/hutech/)index.php\\?language=([a-z-]+)"#');
